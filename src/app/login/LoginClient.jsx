    ...
    <div className="min-h-[calc(100vh-0px)] flex flex-col lg:flex-row bg-white">
      ...
      <div className="flex-1 px-6 py-10 lg:px-16 lg:py-16 flex flex-col justify-center">
        <div className="flex justify-between w-full max-w-md mb-6">
          <h1
            className="text-[#592EA9] font-bold text-lg  cursor-pointer px-30"
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <p className="text-xs text-gray-600 text-center mt-2">
                  ...
                  <a href="/terms" className="text-[#592EA9] hover:underline">
                    Terms & Service
                  </a>{" "}
                  and{" "}
                  <a href="/privacy" className="text-[#592EA9] hover:underline">
                    Privacy Policy
                  </a>
                  .
                </p>
